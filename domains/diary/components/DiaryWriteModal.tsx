...
export function DiaryWriteModal({ initialDate, onClose }: DiaryWriteModalProps) {
            ...
            <div className="bg-white rounded-3xl shadow-xl w-[520px] p-8 relative">
                    ...
                    <>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                disabled={content.trim().length === 0 || generateTitleMutation.isPending}
                ...
                {step === "loading" && (
                    <div className="flex flex-col items-center py-10">
                        ...
                        <p className="text-[#F97316] font-semibold text-lg mb-1">스티커를 그리고 있어요</p>
                        <p className="text-sm text-gray-500">오늘 일기를 읽고 어울리는 스티커를 만드는 중이에요</p>
                    </div>
                )}
